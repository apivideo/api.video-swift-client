...
public struct SummaryObject: Codable, Hashable {
    ...
    public init(summaryId: String? = nil, createdAt: Date? = nil, updatedAt: Date? = nil, videoId: String? = nil, origin: AnyCodable? = nil, sourceStatus: SourceStatus? = nil) {
