...
open class AlamofireRequestBuilder<T>: RequestBuilder<T> {
    ...
    @discardableResult
    override open func execute(_ apiResponseQueue: DispatchQueue = ApiVideoClient.apiResponseQueue, _ completion: @escaping (_ result: Swift.Result<Response<T>, ErrorResponse>) -> Void) -> URLSessionTask? {
        ...
        } else if let apiKey = ApiVideoClient.apiKey {
            // Create the interceptor
            let authenticator = ApiVideoAuthenticator(apiKey: apiKey)
            let interceptor = AuthenticationInterceptor(authenticator: authenticator, credential: ApiVideoClient.credential)
